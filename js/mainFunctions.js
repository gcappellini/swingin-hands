...
window.addEventListener("load", function () {
  if (document.getElementById('insertMail')) {
    let name = "guglielmo.cappellini" ; // Update yours informations here
...
// Locations
$(function () {
    $(".card").on('click', () => {window.location.href = "https://www.instagram.com/framrcni/"});
})
// Location socials
$(function () {
    ...
    $('.instagram').on('click', function(event) {
      event.preventDefault();
      window.location.href = "https://www.instagram.com/framrcni/";
    });
})
