		<?php
				...
				$texte = $texte . "Message from The Swingin' Hands.<br />";
				...
				$destinataire = "guglielmo.cappellini@gmail.com"; // input your email here
				$objet = "Message from your The Swingin' Hands"; // input your domain name here

				// Headers
	      $headers = array(
	                      'Content-type' => 'text/html',
	                      'From' => 'guglielmo.cappellini@gmail.com', // input your email from here
